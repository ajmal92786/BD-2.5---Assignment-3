...
// Function to sort hotels from low to high price
function sortByPricingLowToHigh(hotel1, hotel2) {
  return hotel1.price - hotel2.price;
}

// Function to sort hotels from high to low price
function sortByPricingHighToLow(hotel1, hotel2) {
  return hotel2.price - hotel1.price;
}

// Function to sort the hotels based on the pricing low-to-high or high-to-low.
function sortByPricing(hotels, pricing) {
  let hotelsCopy = hotels.slice();
  if (pricing === 'low-to-high') {
    return hotelsCopy.sort(sortByPricingLowToHigh);
  } else if (pricing === 'high-to-low') {
    return hotelsCopy.sort(sortByPricingHighToLow);
  }
}
...
// Function to sort hotels from low to high rating
function sortByRatingLowToHigh(hotel1, hotel2) {
  return hotel1.rating - hotel2.rating;
}

// Function to sort hotels from high to low rating
function sortByRatingHighToLow(hotel1, hotel2) {
  return hotel2.rating - hotel1.rating;
}

// Function to sort hotels based on their individual ratings.
function sortByRating(hotels, rating) {
  let hotelsCopy = hotels.slice();
  if (rating === 'low-to-high') {
    return hotelsCopy.sort(sortByRatingLowToHigh);
  } else if (rating === 'high-to-low') {
    return hotelsCopy.sort(sortByRatingHighToLow);
  }
}
...
// Function to filter hotels based on the hotel amenities
